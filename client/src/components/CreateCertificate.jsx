    ...
    return (
        <>
            <form onSubmit={handleSubmit} className="certificate-form">
                ...
                <button
                    type="submit"
                    className={`bg-gradient-to-r from-blue-500 to-purple-500 w-full text-white px-4 py-2 rounded-md hover:from-blue-600 hover:to-purple-600 transform transition duration-300 ease-in-out ${
